...
public class Boshi implements Xuesheng, Laoshi{
	 private String name;
	    ...
	    public void statistics() {
	        System.out.println(getName() + "\n" +
	                ...
	                "学生年薪水：" + askSalary() + "\n" +
	                "学生年收入：" + getMoney() + "\n" +
	                "学生缴税：" + Shui.TaxManager.getTax(getMoney()));
	    }
	    ...
	    public Boshi(String name, String gender, int age, float feePerTerm, float salaryPerMonth) {
	        this.name = name;
	        this.gender = gender;
	        this.age = age;
